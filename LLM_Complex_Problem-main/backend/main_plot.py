"""
MathProof Agent — FastAPI + LangGraph backend entry point (PLOT EDITION)
"""
...
from agent.graph_plot import build_graph, _snippet  # <-- using graph_plot
...
app = FastAPI(title="MathProof Agent API (Plot Edition)", lifespan=lifespan)
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
    allow_methods=["*"],
            ...
            for node_name, update in chunk.items():
                ...
                await queue.put({
                    ...
                    "payload": {
                        ...
                        "plot_data": current.get("plot_data", ""),
