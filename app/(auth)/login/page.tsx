  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen overflow-hidden bg-background px-4 py-24">
      ...
      <motion.div
        ...
        className="relative z-10 w-full max-w-md p-8 rounded-3xl border border-[oklch(0.7_0.15_195_/_0.3)] bg-background/60 backdrop-blur-xl shadow-2xl"
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-muted-foreground">Sign in to continue to SolveX</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              required
              className="bg-background/50 border-[oklch(0.7_0.15_195_/_0.2)] focus-visible:ring-[oklch(0.7_0.15_195)]"
            />
          </div>
          ...
          <Button 
            type="submit" 
            disabled={isLoading}
            className="w-full mt-4 bg-[oklch(0.7_0.15_195)] hover:bg-[oklch(0.6_0.15_195)] text-white group"
          >
            {isLoading ? (
        ...
        <div className="mt-6 text-center text-sm text-muted-foreground">
          ...
          <Link href="/signup" className="text-[oklch(0.7_0.15_195)] hover:underline font-medium">
            Sign up
          </Link>
        </div>
      </motion.div>
