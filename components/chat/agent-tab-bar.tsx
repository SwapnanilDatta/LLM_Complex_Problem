...
export function AgentTabBar() {
  ...
  return (
    <div className="relative flex items-center gap-1 px-2 h-14 bg-sidebar border-b border-sidebar-border shrink-0 z-20">
      ...
      {/* Right: App name */}
      <div className="hidden lg:flex items-center gap-1.5 ml-auto pl-4 shrink-0">
        <span className="text-xs font-medium text-muted-foreground tracking-wide">Nexus AI</span>
      </div>
    </div>
  )
}
